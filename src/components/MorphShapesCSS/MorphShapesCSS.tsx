...
const shapePaths = [
  ...
  // 'M90,90 L430,90 L430,430 L90,430 Z',
]

export const MorphShapesCSS: React.FC = () => {
  const [currentIndex, setCurrentIndex] = useState(0)

  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentIndex((prev) => (prev + 1) % shapePaths.length)
    }, 2000)
  ...
  return (
    <div
      style={{
        ...
        width: '50px',
        position: 'relative',
        left: currentIndex === 0 ? '-7px' : '-5px',
        // transition: 'left 1s ease-in-out',
      }}
    >
      <svg width="50" height="40" viewBox="0 0 512 512">
        <path
          fill="#ff0000"
          stroke="#0000ff"
          strokeWidth="10"
          d={shapePaths[currentIndex]}
          style={{
