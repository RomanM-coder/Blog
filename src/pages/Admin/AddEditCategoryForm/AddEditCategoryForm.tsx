  ...
  if (mode === 'add') {
    ...
    if (dirtyFields.file) {
      ...
      if (downloadBlob) {
        ...
        const blobToFile = (downloadBlob: Blob, link: string) =>
          new File([downloadBlob], link, {
  ...
  return (
    <>
      ...
      >
        ...
        <h2>
          {mode === 'add'
            ? t('addEditCatForm.titleAdd')
            : t('addEditCatForm.titleEdit')}
        </h2>
        ...
        <div className={styles.fieldItem} id={styles.fileUpload}>
          <input
          ...
          <div className={styles.containerImage}>
            <div className={styles.imageLabel}>
              {t('addEditCatForm.fileName') + fileName}
            </div>
            {mode === 'add' ? (
              <div
                id="image1"
